...
![手柄驱动转台](demos/转台演示.gif)

—— 2026-09-22 实拍：握手柄推右摇杆，转台做俯仰 / 自转。

> 原片 37 MB / 15.8 s（手机**竖屏** 1080×1920）。按逐帧差分的**运动强度分布**
> 裁掉前 5.5 s 调手柄的静止段，只取动作峰值的 4 s。
> **画面里笔记本屏幕 / 电机齿轮 / 手柄三者纵向铺满整帧，裁不出横版**，
> 只能保留竖幅（320×524，8 fps，无限循环）压到 2.2 MB。
> 完整 9.5 s 视频裁剪版留本地，不进仓库。
