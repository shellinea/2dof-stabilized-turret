...
—— 2026-09-22 实拍：握手柄推右摇杆，转台做俯仰 / 自转，松手即停。

> 原先那版是竖屏拍的，笔记本 / 电机 / 手柄三者纵向铺满整帧，
> 只能出又高又窄的 GIF；所以横屏重拍了一版。
> 按逐帧差分的**运动强度分布**取动作最密的 5.5–9.5 s，
> 含结尾松手停住那段；转 GIF（480×270，8 fps，无限循环）压到 2.2 MB。
